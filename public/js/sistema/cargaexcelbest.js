$(function () {
    ...
    $("#descargaExcel").click(function () {
        ...
        window.open('cargaexcelbest/excelErrores/' + idbase, '_blank');
    });
    ...
    $("#continuar").click(function () {
        ...
        if ($("#habilitafecha").is(":checked")) {
            ...
            $(".modalaviso").modal("hide");
            subirArchivos("cargaexcelbest/cargaExcel", fecha);
        } else {
            $("#registrosOk").addClass("hidden");
            $("#descargaExcel").addClass("hidden");
            $(".modalaviso").modal("hide");
...
//                $("#regerrores").html(data.errores + " SMS");
    ...
    $("#confirmacioncarga").click(function () {
        ...
        var res = crud(obj, 'cargaexcelbest/procesarCarga');
        res.success(function (data) {
...
function verErrores(id) {
    ...
    var res = crud(obj, 'cargaexcelbest/verErrores');
    res.success(function (data) {
        tableResult(data);
    })
}
...
function verBlacklist(id) {
    ...
    $(".modalbase").modal("show");
    $("#tablabase tbody").empty();
    var res = crud(obj, 'cargaexcelbest/verBlacklist');
    res.success(function (data) {
        tableResult(data);
    })
}
...
function tableResult(data) {
    ...
    $.each(data, function (i, val) {
        error = (val["error"] == undefined) ? "Ok" : val["error"];
        txt += '<tr>';
...
function verBase(id) {
    ...
    obj.idbase = id;
    $(".modalbase").modal("show");
    var res = crud(obj, 'cargaexcelbest/verBase');
    res.success(function (data) {
        tableResult(data);
    })
}
...
function trash() {
    ...
    var res = crud(objeto, 'cargaexcelbest/borrarArchivo', 'JSON');
}
...
function leerRegistros(objeto) {
    var res = crud(objeto, "cargaexcelbest/cuentaRegistros", 'JSON');
    res.success(function (data) {
...
function traeRegistros(objeto) {
    var res = crud(objeto, "cargaexcelbest/otroRegistros", 'JSON');
    res.success(function (data) {
